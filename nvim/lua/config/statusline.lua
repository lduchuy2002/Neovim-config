...
hl(0, diagnostic_error_group_status, { fg = palette.red })
hl(0, diagnostic_warn_group_status, { fg = palette.yellow })
hl(0, diagnostic_hint_group_status, { fg = palette.green })
hl(0, diagnostic_info_group_status, { fg = palette.blue })
